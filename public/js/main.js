...
<li>Electricity can be <b>manually</b> bought and sold at market price in the topmost panel.</li>
    ...
    notEnoughHydrogenToSell:
      "Not enough hydrogen to sell. You have {have} g, tried to sell {tried} g.",
...
<li>Strom kann <b>manuell</b> zum Marktpreis im obersten Panel gekauft und verkauft werden.</li>
    ...
    notEnoughHydrogenToSell:
      "Nicht genügend Wasserstoff zum Verkaufen. Sie haben {have} g, versucht zu verkaufen {tried} g.",
    ...
    fuelcellStoppedNoHydrogen:
      "Brennstoffzelle gestoppt: Kein Wasserstoff vorhanden.",
    ...
    notEnoughBattery:
      "Nicht genügend Batteriespeicher, um den Elektrolyseur zu starten.",
